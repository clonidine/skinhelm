/* @ts-self-types="./skinhelm_wasm.d.ts" */

export class SkinhelmViewer {
    static __wrap(ptr) {
        const obj = Object.create(SkinhelmViewer.prototype);
        obj.__wbg_ptr = ptr;
        SkinhelmViewerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SkinhelmViewerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_skinhelmviewer_free(ptr, 0);
    }
    clear_cape() {
        wasm.skinhelmviewer_clear_cape(this.__wbg_ptr);
    }
    /**
     * @returns {SkinhelmViewer}
     */
    static init() {
        const ret = wasm.skinhelmviewer_init();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return SkinhelmViewer.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} bytes
     */
    load_cape_bytes(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.skinhelmviewer_load_cape_bytes(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    load_default_skin() {
        const ret = wasm.skinhelmviewer_load_default_skin(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {Uint8Array} bytes
     */
    load_skin_bytes(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.skinhelmviewer_load_skin_bytes(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {boolean} slim
     */
    load_skin_bytes_with_model(bytes, slim) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.skinhelmviewer_load_skin_bytes_with_model(this.__wbg_ptr, ptr0, len0, slim);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pointer_down(x, y) {
        wasm.skinhelmviewer_pointer_down(this.__wbg_ptr, x, y);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    pointer_move(x, y) {
        wasm.skinhelmviewer_pointer_move(this.__wbg_ptr, x, y);
    }
    pointer_up() {
        wasm.skinhelmviewer_pointer_up(this.__wbg_ptr);
    }
    /**
     * @param {number} timestamp_ms
     */
    render_frame(timestamp_ms) {
        const ret = wasm.skinhelmviewer_render_frame(this.__wbg_ptr, timestamp_ms);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    resize() {
        const ret = wasm.skinhelmviewer_resize(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    set_animation_enabled(enabled) {
        wasm.skinhelmviewer_set_animation_enabled(this.__wbg_ptr, enabled);
    }
    /**
     * @param {number} speed
     */
    set_animation_speed(speed) {
        wasm.skinhelmviewer_set_animation_speed(this.__wbg_ptr, speed);
    }
    /**
     * @param {boolean} visible
     * @returns {string}
     */
    set_cape_visible(visible) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.skinhelmviewer_set_cape_visible(this.__wbg_ptr, visible);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    set_overlays_enabled(enabled) {
        wasm.skinhelmviewer_set_overlays_enabled(this.__wbg_ptr, enabled);
    }
    /**
     * @param {string} preset
     * @returns {string}
    ...
    set_preset(preset) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.skinhelmviewer_set_preset(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    wheel(delta_y) {
        wasm.skinhelmviewer_wheel(this.__wbg_ptr, delta_y);
    }
}
if (Symbol.dispose) SkinhelmViewer.prototype[Symbol.dispose] = SkinhelmViewer.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./skinhelm_wasm_bg.js": import0,
    };
}

const SkinhelmViewerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_skinhelmviewer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('skinhelm_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
